...
int cellvoltage[BOARDCOUNT * 6];// array to store all the cellvoltages.
uint16_t temparatures [BOARDCOUNT * 2]; // array for storing system temperatures. 2 values per board(1+), 1for the microcontroller(0).
