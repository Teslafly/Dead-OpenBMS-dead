...
uint16_t cellVoltage[(BALANCERCOUNT * 6) - 1];// array to store all the cellvoltages.
uint16_t CellCalVal[(BALANCERCOUNT * 6) - 1];// array to store all calibration values for cells.
...
void loop(){
  ...
  */
  ...
  //ATA68_bulkRead(0); // bulk read command tester
