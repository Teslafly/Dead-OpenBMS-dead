...
void BeginComms(int baudRate)// start ble and serial stuff
{
  ...
  root["status"] = "balancing";
  //root["message"] = number;

  JsonArray& data = root.createNestedArray("cellvolts");
  data.add(48.756080, 3);  // 6 is the number of decimals to print
  data.add(2.302038, 6);   // if not specified, 2 digits are printed

  //root.printTo(Serial);
  // This prints:
  // {"status":"gps","message":1351824120,"data":[48.756080,2.302038]}
...
void serialSemd(String msg)
{
      ...
      char sendbuffersize = min(100, msg.length());
